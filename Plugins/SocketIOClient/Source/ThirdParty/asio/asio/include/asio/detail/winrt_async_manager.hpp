...
class winrt_async_manager
  : public asio_sockio::detail::service_base<winrt_async_manager>
{
public:
  // Constructor.
  winrt_async_manager(asio_sockio::io_context& io_context)
    : asio_sockio::detail::service_base<winrt_async_manager>(io_context),
      ...
      asio_sockio::error_code& ec)
  {
    ...
    auto promise = std::make_shared<std::promise<asio_sockio::error_code>>();
    ...
    action->Completed = ref new AsyncActionCompletedHandler(
      [promise](IAsyncAction^ action, AsyncStatus status)
      {
        ...
        case AsyncStatus::Canceled:
          promise->set_value(asio_sockio::error::operation_aborted);
          break;
      ...
      winrt_async_op<void>* handler)
  {
    ...
    auto on_completed = ref new AsyncActionCompletedHandler(
      [this, handler](IAsyncAction^ action, AsyncStatus status)
      {
        ...
        {
        case AsyncStatus::Canceled:
          handler->ec_ = asio_sockio::error::operation_aborted;
          break;
        case AsyncStatus::Started:
          return;
        case AsyncStatus::Completed:
        case AsyncStatus::Error:
        default:
          handler->ec_ = asio_sockio::error_code(
              action->ErrorCode.Value,
              asio_sockio::system_category());
          break;
        }
