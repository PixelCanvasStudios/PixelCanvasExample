 ...
 * asio_sockio::streambuf::mutable_buffers_type bufs = b.prepare(512);
 *
...
public:
  ...
  {
    return asio_sockio::buffer(asio_sockio::const_buffer(gptr(),
  ...
  {
    reserve(n);
    return asio_sockio::buffer(asio_sockio::mutable_buffer(
...
protected:
  ...
  void reserve(std::size_t n)
  {
    ...
    if (n > pend - pnext)
    {
      ...
      {
        std::length_error ex("asio_sockio::streambuf too long");
