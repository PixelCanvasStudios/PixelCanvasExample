...
public:
  do_init()
  {
    ...
    for (size_t i = 0; i < mutexes_.size(); ++i)
      mutexes_[i].reset(new asio_sockio::detail::mutex);
...
private:
  ...
  std::vector<asio_sockio::detail::shared_ptr<
        asio_sockio::detail::mutex> > mutexes_;
#endif // (OPENSSL_VERSION_NUMBER < 0x10100000L)
...
asio_sockio::detail::shared_ptr<openssl_init_base::do_init>
openssl_init_base::instance()
{
  static asio_sockio::detail::shared_ptr<do_init> init(new do_init);
  return init;
}
