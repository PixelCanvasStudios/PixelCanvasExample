...
public:
   ...
   * the socket.
   */
  explicit basic_seq_packet_socket(asio_sockio::io_context& io_context)
   ...
   */
  basic_seq_packet_socket(asio_sockio::io_context& io_context,
   ...
   * follows:
   * @code
   * socket.receive(asio_sockio::buffer(data, size), out_flags);
   * @endcode
   ...
   * follows:
   * @code
   * socket.receive(asio_sockio::buffer(data, size), 0, out_flags);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(asio_sockio::buffer(data, size), out_flags, handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
