...
public:
  ...
  ASIO_DECL asio_sockio::error_code open(implementation_type& impl,
  ...
  // Destroy a serial port implementation.
  asio_sockio::error_code close(implementation_type& impl,
      asio_sockio::error_code& ec)
  {
  ...
  asio_sockio::error_code cancel(implementation_type& impl,
      asio_sockio::error_code& ec)
  {
  ...
  asio_sockio::error_code set_option(implementation_type& impl,
      const SettableSerialPortOption& option, asio_sockio::error_code& ec)
  {
  ...
  asio_sockio::error_code get_option(const implementation_type& impl,
      GettableSerialPortOption& option, asio_sockio::error_code& ec) const
  {
  ...
  asio_sockio::error_code send_break(implementation_type& impl,
      asio_sockio::error_code& ec)
  {
    errno = 0;
...
private:
  ...
  typedef asio_sockio::error_code (*store_function_type)(
      const void*, termios&, asio_sockio::error_code&);

  // Helper function template to store a serial port option.
  template <typename SettableSerialPortOption>
  static asio_sockio::error_code store_option(const void* option,
      termios& storage, asio_sockio::error_code& ec)
  {
  ...
  ASIO_DECL asio_sockio::error_code do_set_option(
  ...
  typedef asio_sockio::error_code (*load_function_type)(
      void*, const termios&, asio_sockio::error_code&);

  // Helper function template to load a serial port option.
  template <typename GettableSerialPortOption>
  static asio_sockio::error_code load_option(void* option,
      const termios& storage, asio_sockio::error_code& ec)
  {
  ...
  ASIO_DECL asio_sockio::error_code do_get_option(
