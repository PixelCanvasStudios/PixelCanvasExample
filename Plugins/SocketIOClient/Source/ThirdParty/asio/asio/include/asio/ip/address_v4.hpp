...
/**
 * The asio_sockio::ip::address_v4 class provides the ability to use and
...
#else
  typedef asio_sockio::detail::array<unsigned char, 4> bytes_type;
#endif
...
private:
  ...
  asio_sockio::detail::in4_addr_type addr_;
};
 ...
 *
 * @relates asio_sockio::ip::address_v4
 */
