...
/**
 * The asio_sockio::ip::basic_resolver_query class template describes a query
...
public:
  ...
  const asio_sockio::detail::addrinfo_type& hints() const
  {
    return hints_;
  }
...
private:
  asio_sockio::detail::addrinfo_type hints_;
