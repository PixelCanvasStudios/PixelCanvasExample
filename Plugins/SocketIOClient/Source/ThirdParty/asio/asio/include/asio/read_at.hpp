...
/**
 * @defgroup read_at asio_sockio::read_at
 *
 ...
 * @code asio_sockio::read_at(d, 42, asio_sockio::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code asio_sockio::read_at(
 *     d, 42, buffers,
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code asio_sockio::read_at(d, 42, asio_sockio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_read_at asio_sockio::async_read_at
 *
 ...
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code
 * asio_sockio::async_read_at(d, 42, asio_sockio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code asio_sockio::async_read_at(
 *     d, 42, buffers,
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code asio_sockio::async_read_at(d, 42,
