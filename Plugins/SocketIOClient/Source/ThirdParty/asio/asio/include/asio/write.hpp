...
/**
 * @defgroup write asio_sockio::write
 *
 ...
 * @code asio_sockio::write(s, asio_sockio::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code asio_sockio::write(
 *     s, buffers,
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code asio_sockio::write(s, asio_sockio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code asio_sockio::write(s, asio_sockio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_write asio_sockio::async_write
 *
 ...
 * To write a single data buffer use the @ref buffer function as follows:
 * @code
 * asio_sockio::async_write(s, asio_sockio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code asio_sockio::async_write(s,
