...
public:
  ...
  asio_sockio::detail::socket_addr_type* data()
  {
    return &data_.base;
  }

  // Get the underlying endpoint in the native type.
  const asio_sockio::detail::socket_addr_type* data() const
  {
    return &data_.base;
  }
  ...
  {
    return path_length_
      + offsetof(asio_sockio::detail::sockaddr_un_type, sun_path);
  }
  ...
  {
    return sizeof(asio_sockio::detail::sockaddr_un_type);
  }
...
private:
  ...
  union data_union
  {
    ...
    asio_sockio::detail::sockaddr_un_type local;
  } data_;
