...
#define ASIO_SVC_T asio_sockio::detail::win_iocp_handle_service
...
public:
   ...
   */
  explicit overlapped_handle(asio_sockio::io_context& io_context)
   ...
   */
  overlapped_handle(asio_sockio::io_context& io_context,
