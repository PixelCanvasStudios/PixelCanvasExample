...
public:
   ...
   * ...
   * asio_sockio::socket_base::broadcast option(true);
   ...
   * asio_sockio::ip::udp::socket socket(io_context); 
   * ...
   * asio_sockio::socket_base::broadcast option;
...
#else
  typedef asio_sockio::detail::socket_option::boolean<
   ...
   * ...
   * asio_sockio::socket_base::debug option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * asio_sockio::ip::tcp::socket socket(io_context); 
   * ...
   * asio_sockio::socket_base::debug option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * asio_sockio::ip::udp::socket socket(io_context); 
   * ...
   * asio_sockio::socket_base::do_not_route option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * asio_sockio::ip::udp::socket socket(io_context); 
   * ...
   * asio_sockio::socket_base::do_not_route option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * asio_sockio::ip::tcp::socket socket(io_context); 
   * ...
   * asio_sockio::socket_base::keep_alive option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * asio_sockio::ip::tcp::socket socket(io_context); 
   * ...
   * asio_sockio::socket_base::keep_alive option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * asio_sockio::ip::tcp::socket socket(io_context); 
   * ...
   * asio_sockio::socket_base::send_buffer_size option(8192);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * asio_sockio::ip::tcp::socket socket(io_context); 
   * ...
   * asio_sockio::socket_base::send_buffer_size option;
   * socket.get_option(option);
...
#else
  typedef asio_sockio::detail::socket_option::integer<
   ...
   * asio_sockio::ip::tcp::socket socket(io_context); 
   * ...
   * asio_sockio::socket_base::send_low_watermark option(1024);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * asio_sockio::ip::tcp::socket socket(io_context); 
   * ...
   * asio_sockio::socket_base::send_low_watermark option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * asio_sockio::ip::tcp::socket socket(io_context); 
   * ...
   * asio_sockio::socket_base::receive_buffer_size option(8192);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * asio_sockio::ip::tcp::socket socket(io_context); 
   * ...
   * asio_sockio::socket_base::receive_buffer_size option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * asio_sockio::ip::tcp::socket socket(io_context); 
   * ...
   * asio_sockio::socket_base::receive_low_watermark option(1024);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * asio_sockio::ip::tcp::socket socket(io_context); 
   * ...
   * asio_sockio::socket_base::receive_low_watermark option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * ...
   * asio_sockio::socket_base::reuse_address option(true);
   ...
   * asio_sockio::ip::tcp::acceptor acceptor(io_context); 
   * ...
   * asio_sockio::socket_base::reuse_address option;
   ...
   * asio_sockio::ip::tcp::socket socket(io_context); 
   * ...
   * asio_sockio::socket_base::linger option(true, 30);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * asio_sockio::ip::tcp::socket socket(io_context); 
   * ...
   * asio_sockio::socket_base::linger option;
   * socket.get_option(option);
...
#else
  typedef asio_sockio::detail::socket_option::linger<
   ...
   * asio_sockio::ip::tcp::socket socket(io_context);
   * ...
   * asio_sockio::socket_base::out_of_band_inline option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * asio_sockio::ip::tcp::socket socket(io_context);
   * ...
   * asio_sockio::socket_base::out_of_band_inline option;
   * socket.get_option(option);
   ...
   * operation is permitted to fail with asio_sockio::error::connection_aborted.
   ...
   * asio_sockio::ip::tcp::acceptor acceptor(io_context); 
   * ...
   * asio_sockio::socket_base::enable_connection_aborted option(true);
   * acceptor.set_option(option);
   * @endcode
   *
   * @par
   ...
   * asio_sockio::ip::tcp::acceptor acceptor(io_context); 
   * ...
   * asio_sockio::socket_base::enable_connection_aborted option;
   * acceptor.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
...
#else
  typedef asio_sockio::detail::socket_option::boolean<
    asio_sockio::detail::custom_socket_option_level,
    asio_sockio::detail::enable_connection_aborted_option>
   ...
   * asio_sockio::ip::tcp::socket socket(io_context); 
   * ...
   * asio_sockio::socket_base::bytes_readable command(true);
...
#else
  typedef asio_sockio::detail::io_control::bytes_readable bytes_readable;
#endif
