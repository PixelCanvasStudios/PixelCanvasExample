...
inline const asio_sockio::error_category& get_system_category()
{
  return asio_sockio::system_category();
}

#if !defined(ASIO_WINDOWS) && !defined(__CYGWIN__)

extern ASIO_DECL
const asio_sockio::error_category& get_netdb_category();

extern ASIO_DECL
const asio_sockio::error_category& get_addrinfo_category();

#else // !defined(ASIO_WINDOWS) && !defined(__CYGWIN__)

inline const asio_sockio::error_category& get_netdb_category()
{
  return get_system_category();
}

inline const asio_sockio::error_category& get_addrinfo_category()
{
  return get_system_category();
}
...
extern ASIO_DECL
const asio_sockio::error_category& get_misc_category();

static const asio_sockio::error_category&
  system_category ASIO_UNUSED_VARIABLE
  = asio_sockio::error::get_system_category();
static const asio_sockio::error_category&
  netdb_category ASIO_UNUSED_VARIABLE
  = asio_sockio::error::get_netdb_category();
static const asio_sockio::error_category&
  addrinfo_category ASIO_UNUSED_VARIABLE
  = asio_sockio::error::get_addrinfo_category();
static const asio_sockio::error_category&
  misc_category ASIO_UNUSED_VARIABLE
  = asio_sockio::error::get_misc_category();
...
template<> struct is_error_code_enum<asio_sockio::error::basic_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<asio_sockio::error::netdb_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<asio_sockio::error::addrinfo_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<asio_sockio::error::misc_errors>
{
  static const bool value = true;
};
...
inline asio_sockio::error_code make_error_code(basic_errors e)
{
  return asio_sockio::error_code(
      static_cast<int>(e), get_system_category());
}

inline asio_sockio::error_code make_error_code(netdb_errors e)
{
  return asio_sockio::error_code(
      static_cast<int>(e), get_netdb_category());
}

inline asio_sockio::error_code make_error_code(addrinfo_errors e)
{
  return asio_sockio::error_code(
      static_cast<int>(e), get_addrinfo_category());
}

inline asio_sockio::error_code make_error_code(misc_errors e)
{
  return asio_sockio::error_code(
