...
public:
...
#endif // defined(__GNUC__) && (__GNUC__ == 4) && (__GNUC_MINOR__ == 3)
  {
    ...
    new_iter.begin_ = asio_sockio::buffer_sequence_begin(buffers);
    new_iter.current_ = asio_sockio::buffer_sequence_begin(buffers);
    new_iter.end_ = asio_sockio::buffer_sequence_end(buffers);
