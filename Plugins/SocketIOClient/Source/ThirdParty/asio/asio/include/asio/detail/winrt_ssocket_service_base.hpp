...
public:
  ...
  asio_sockio::error_code cancel(base_implementation_type&,
  ...
  asio_sockio::error_code io_control(base_implementation_type&,
  ...
  asio_sockio::error_code non_blocking(base_implementation_type&,
  ...
  asio_sockio::error_code native_non_blocking(base_implementation_type&,
      bool, asio_sockio::error_code& ec)
  {
    ec = asio_sockio::error::operation_not_supported;
    return ec;
  ...
  asio_sockio::error_code shutdown(base_implementation_type&,
...
protected:
  ...
  ASIO_DECL asio_sockio::error_code do_connect(
      base_implementation_type& impl,
  ...
  ASIO_DECL std::size_t do_send(
      base_implementation_type& impl, const asio_sockio::const_buffer& data,
      socket_base::message_flags flags, asio_sockio::error_code& ec);
  ...
  ASIO_DECL std::size_t do_receive(
      base_implementation_type& impl, const asio_sockio::mutable_buffer& data,
      socket_base::message_flags flags, asio_sockio::error_code& ec);
