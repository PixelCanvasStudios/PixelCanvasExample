...
select_reactor::select_reactor(asio_sockio::execution_context& ctx)
...
{
#if defined(ASIO_HAS_IOCP)
  asio_sockio::detail::signal_blocker sb;
  thread_ = new asio_sockio::detail::thread(thread_function(this));
#endif // defined(ASIO_HAS_IOCP)
}
