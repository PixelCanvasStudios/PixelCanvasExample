...
ASIO_SYNC_OP_VOID context::set_verify_callback(
    VerifyCallback callback, asio_sockio::error_code& ec)
{
...
void context::set_password_callback(PasswordCallback callback)
{
  ...
  asio_sockio::detail::throw_error(ec, "set_password_callback");
}

template <typename PasswordCallback>
ASIO_SYNC_OP_VOID context::set_password_callback(
    PasswordCallback callback, asio_sockio::error_code& ec)
{
