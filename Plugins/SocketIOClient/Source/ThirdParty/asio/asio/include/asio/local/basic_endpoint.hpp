...
/**
 * The asio_sockio::local::basic_endpoint class template describes an endpoint
...
private:
  ...
  asio_sockio::local::detail::endpoint impl_;
};
 ...
 *
 * @relates asio_sockio::local::basic_endpoint
 */
