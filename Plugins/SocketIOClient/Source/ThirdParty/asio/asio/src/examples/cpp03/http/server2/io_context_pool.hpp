...
private:
  typedef boost::shared_ptr<asio_sockio::io_context> io_context_ptr;
  typedef asio_sockio::executor_work_guard<
    asio_sockio::io_context::executor_type> io_context_work;
