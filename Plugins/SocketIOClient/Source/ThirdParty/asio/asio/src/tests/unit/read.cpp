...
public:
  ...
  {
    return check_buffers(asio_sockio::buffer_sequence_begin(buffers),
...
void test_2_arg_zero_buffers_read()
{
  ...
  test_stream s(ioc);
  std::vector<asio_sockio::mutable_buffer> buffers;

  size_t bytes_transferred = asio_sockio::read(s, buffers);
...
void test_2_arg_mutable_buffer_read()
{
  ...
  asio_sockio::mutable_buffer buffers
    = asio_sockio::buffer(read_buf, sizeof(read_buf));
  ...
  memset(read_buf, 0, sizeof(read_buf));
  bytes_transferred = asio_sockio::read(s, buffers);
  ASIO_CHECK(bytes_transferred == sizeof(read_data));
  ASIO_CHECK(s.check_buffers(buffers, sizeof(read_data)));
...
void test_2_arg_vector_buffers_read()
{
  ...
  char read_buf[sizeof(read_data)];
  std::vector<asio_sockio::mutable_buffer> buffers;
  buffers.push_back(asio_sockio::buffer(read_buf, 32));
  buffers.push_back(asio_sockio::buffer(read_buf, 39) + 32);
  buffers.push_back(asio_sockio::buffer(read_buf) + 39);
...
void test_2_arg_streambuf_read()
{
  asio_sockio::io_context ioc;
  test_stream s(ioc);
  asio_sockio::streambuf sb(sizeof(read_data));

  s.reset(read_data, sizeof(read_data));
  sb.consume(sb.size());
  size_t bytes_transferred = asio_sockio::read(s, sb);
  ASIO_CHECK(bytes_transferred == sizeof(read_data));
  ...
  s.next_read_length(1);
  sb.consume(sb.size());
  bytes_transferred = asio_sockio::read(s, sb);
  ASIO_CHECK(bytes_transferred == sizeof(read_data));
  ASIO_CHECK(sb.size() == sizeof(read_data));
  ASIO_CHECK(s.check_buffers(sb.data(), sizeof(read_data)));
...
void test_3_arg_nothrow_zero_buffers_read()
{
  ...
  size_t bytes_transferred = asio_sockio::read(s, buffers, error);
  ASIO_CHECK(bytes_transferred == 0);
  ASIO_CHECK(!error);
}
...
void test_3_arg_nothrow_mutable_buffer_read()
{
  ...
  s.next_read_length(1);
  memset(read_buf, 0, sizeof(read_buf));
  bytes_transferred = asio_sockio::read(s, buffers, error);
  ASIO_CHECK(bytes_transferred == sizeof(read_data));
  ASIO_CHECK(s.check_buffers(buffers, sizeof(read_data)));
  ASIO_CHECK(!error);
...
void test_3_arg_nothrow_streambuf_read()
{
  ...
  sb.consume(sb.size());
  asio_sockio::error_code error;
  size_t bytes_transferred = asio_sockio::read(s, sb, error);
  ASIO_CHECK(bytes_transferred == sizeof(read_data));
  ASIO_CHECK(sb.size() == sizeof(read_data));
  ASIO_CHECK(s.check_buffers(sb.data(), sizeof(read_data)));
  ASIO_CHECK(!error);
  ...
  s.next_read_length(1);
  sb.consume(sb.size());
  bytes_transferred = asio_sockio::read(s, sb, error);
  ASIO_CHECK(bytes_transferred == sizeof(read_data));
  ASIO_CHECK(sb.size() == sizeof(read_data));
  ASIO_CHECK(s.check_buffers(sb.data(), sizeof(read_data)));
  ASIO_CHECK(!error);
...
void test_3_arg_mutable_buffer_read()
{
  ...
  s.reset(read_data, sizeof(read_data));
  memset(read_buf, 0, sizeof(read_buf));
  bytes_transferred = asio_sockio::read(s, buffers, old_style_transfer_all);
  ASIO_CHECK(bytes_transferred == sizeof(read_data));
  ASIO_CHECK(s.check_buffers(buffers, sizeof(read_data)));
  ...
  s.reset(read_data, sizeof(read_data));
  memset(read_buf, 0, sizeof(read_buf));
  bytes_transferred = asio_sockio::read(s, buffers, short_transfer);
  ASIO_CHECK(bytes_transferred == sizeof(read_data));
  ASIO_CHECK(s.check_buffers(buffers, sizeof(read_data)));
...
void test_3_arg_streambuf_read()
{
  ...
  s.reset(read_data, sizeof(read_data));
  sb.consume(sb.size());
  bytes_transferred = asio_sockio::read(s, sb, old_style_transfer_all);
  ASIO_CHECK(bytes_transferred == sizeof(read_data));
  ASIO_CHECK(sb.size() == sizeof(read_data));
  ASIO_CHECK(s.check_buffers(sb.data(), sizeof(read_data)));
  ...
  s.reset(read_data, sizeof(read_data));
  sb.consume(sb.size());
  bytes_transferred = asio_sockio::read(s, sb, short_transfer);
  ASIO_CHECK(bytes_transferred == sizeof(read_data));
  ASIO_CHECK(sb.size() == sizeof(read_data));
  ASIO_CHECK(s.check_buffers(sb.data(), sizeof(read_data)));
...
void test_4_arg_mutable_buffer_read()
{
  ...
  s.reset(read_data, sizeof(read_data));
  memset(read_buf, 0, sizeof(read_buf));
  bytes_transferred = asio_sockio::read(s, buffers, short_transfer, error);
  ASIO_CHECK(bytes_transferred == sizeof(read_data));
  ASIO_CHECK(s.check_buffers(buffers, sizeof(read_data)));
  ASIO_CHECK(!error);
...
void test_4_arg_streambuf_read()
{
  ...
  s.reset(read_data, sizeof(read_data));
  sb.consume(sb.size());
  bytes_transferred = asio_sockio::read(s, sb, short_transfer, error);
  ASIO_CHECK(bytes_transferred == sizeof(read_data));
  ASIO_CHECK(sb.size() == sizeof(read_data));
  ASIO_CHECK(s.check_buffers(sb.data(), sizeof(read_data)));
  ASIO_CHECK(!error);
...
void async_read_handler(const asio_sockio::error_code& e,
...
void test_3_arg_mutable_buffer_async_read()
{
  ...
  memset(read_buf, 0, sizeof(read_buf));
  bool called = false;
  asio_sockio::async_read(s, buffers,
  ...
  s.reset(read_data, sizeof(read_data));
  memset(read_buf, 0, sizeof(read_buf));
  int i = asio_sockio::async_read(s, buffers, archetypes::lazy_handler());
  ASIO_CHECK(i == 42);
  ioc.restart();
  ioc.run();
  ASIO_CHECK(s.check_buffers(buffers, sizeof(read_data)));
...
void test_3_arg_boost_array_buffers_async_read()
{
  ...
  test_stream s(ioc);
  char read_buf[sizeof(read_data)];
  boost::array<asio_sockio::mutable_buffer, 2> buffers = { {
    asio_sockio::buffer(read_buf, 32),
    asio_sockio::buffer(read_buf) + 32 } };
...
void test_3_arg_std_array_buffers_async_read()
{
  ...
  test_stream s(ioc);
  char read_buf[sizeof(read_data)];
  std::array<asio_sockio::mutable_buffer, 2> buffers = { {
    asio_sockio::buffer(read_buf, 32),
    asio_sockio::buffer(read_buf) + 32 } };
...
void test_3_arg_streambuf_async_read()
{
  ...
  s.reset(read_data, sizeof(read_data));
  sb.consume(sb.size());
  int i = asio_sockio::async_read(s, sb, archetypes::lazy_handler());
  ASIO_CHECK(i == 42);
  ioc.restart();
  ioc.run();
  ASIO_CHECK(sb.size() == sizeof(read_data));
...
void test_4_arg_mutable_buffer_async_read()
{
  ...
  memset(read_buf, 0, sizeof(read_buf));
  bool called = false;
  asio_sockio::async_read(s, buffers, asio_sockio::transfer_all(),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  asio_sockio::async_read(s, buffers, asio_sockio::transfer_at_least(1),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  asio_sockio::async_read(s, buffers, asio_sockio::transfer_at_least(10),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  asio_sockio::async_read(s, buffers, asio_sockio::transfer_at_least(42),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  asio_sockio::async_read(s, buffers, asio_sockio::transfer_exactly(1),
      bindns::bind(async_read_handler,
        _1, _2, 1, &called));
  ioc.restart();
  ioc.run();
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  asio_sockio::async_read(s, buffers, asio_sockio::transfer_exactly(10),
      bindns::bind(async_read_handler,
        _1, _2, 10, &called));
  ioc.restart();
  ioc.run();
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  asio_sockio::async_read(s, buffers, asio_sockio::transfer_exactly(42),
      bindns::bind(async_read_handler,
        _1, _2, 42, &called));
  ioc.restart();
  ioc.run();
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  asio_sockio::async_read(s, buffers, old_style_transfer_all,
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  asio_sockio::async_read(s, buffers, short_transfer,
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset(read_data, sizeof(read_data));
  memset(read_buf, 0, sizeof(read_buf));
  int i = asio_sockio::async_read(s, buffers,
...
void test_4_arg_streambuf_async_read()
{
  ...
  sb.consume(sb.size());
  bool called = false;
  asio_sockio::async_read(s, sb, asio_sockio::transfer_all(),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  asio_sockio::async_read(s, sb, asio_sockio::transfer_at_least(1),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  asio_sockio::async_read(s, sb, asio_sockio::transfer_at_least(10),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  asio_sockio::async_read(s, sb, asio_sockio::transfer_at_least(42),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  asio_sockio::async_read(s, sb, asio_sockio::transfer_exactly(1),
      bindns::bind(async_read_handler,
        _1, _2, 1, &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  asio_sockio::async_read(s, sb, asio_sockio::transfer_exactly(10),
      bindns::bind(async_read_handler,
        _1, _2, 10, &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  asio_sockio::async_read(s, sb, asio_sockio::transfer_exactly(42),
      bindns::bind(async_read_handler,
        _1, _2, 42, &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  asio_sockio::async_read(s, sb, old_style_transfer_all,
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  asio_sockio::async_read(s, sb, short_transfer,
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset(read_data, sizeof(read_data));
  sb.consume(sb.size());
  int i = asio_sockio::async_read(s, sb,
      short_transfer, archetypes::lazy_handler());
  ASIO_CHECK(i == 42);
  ioc.restart();
  ioc.run();
