...
public:
  ...
  {
    size_t n = asio_sockio::buffer_copy(
  ...
  template <typename Const_Buffers>
  size_t write_some(const Const_Buffers& buffers, asio_sockio::error_code& ec)
  {
...
void test_2_arg_zero_buffers_write()
{
  ...
  size_t bytes_transferred = asio_sockio::write(s, buffers);
...
void test_2_arg_const_buffer_write()
{
  ...
  bytes_transferred = asio_sockio::write(s, buffers);
  ASIO_CHECK(bytes_transferred == sizeof(write_data));
  ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
...
void test_2_arg_vector_buffers_write()
{
  ...
  buffers.push_back(asio_sockio::buffer(write_data, 39) + 32);
  buffers.push_back(asio_sockio::buffer(write_data) + 39);
...
void test_3_arg_nothrow_zero_buffers_write()
{
  ...
  size_t bytes_transferred = asio_sockio::write(s, buffers, error);
  ASIO_CHECK(bytes_transferred == 0);
  ASIO_CHECK(!error);
}
...
void test_3_arg_nothrow_const_buffer_write()
{
  ...
  s.reset();
  s.next_write_length(1);
  bytes_transferred = asio_sockio::write(s, buffers, error);
  ASIO_CHECK(bytes_transferred == sizeof(write_data));
  ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
  ASIO_CHECK(!error);
...
void test_3_arg_const_buffer_write()
{
  ...
  s.reset();
  bytes_transferred = asio_sockio::write(s, buffers, old_style_transfer_all);
  ASIO_CHECK(bytes_transferred == sizeof(write_data));
  ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
  ...
  s.reset();
  bytes_transferred = asio_sockio::write(s, buffers, short_transfer);
  ASIO_CHECK(bytes_transferred == sizeof(write_data));
  ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
...
void test_4_arg_const_buffer_write()
{
  ...
  s.reset();
  bytes_transferred = asio_sockio::write(s, buffers, short_transfer, error);
  ASIO_CHECK(bytes_transferred == sizeof(write_data));
  ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
  ASIO_CHECK(!error);
...
void test_3_arg_const_buffer_async_write()
{
  ...
  s.reset();
  bool called = false;
  asio_sockio::async_write(s, buffers,
  ...
  s.reset();
  int i = asio_sockio::async_write(s, buffers, archetypes::lazy_handler());
  ASIO_CHECK(i == 42);
  ioc.restart();
  ioc.run();
  ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
...
void test_3_arg_streambuf_async_write()
{
  ...
  sb.consume(sb.size());
  sb.sputn(write_data, sizeof(write_data));
  int i = asio_sockio::async_write(s, sb, archetypes::lazy_handler());
  ASIO_CHECK(i == 42);
  ioc.restart();
  ioc.run();
  ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
...
void test_4_arg_const_buffer_async_write()
{
  ...
  s.reset();
  bool called = false;
  asio_sockio::async_write(s, buffers, asio_sockio::transfer_all(),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  called = false;
  asio_sockio::async_write(s, buffers, asio_sockio::transfer_at_least(1),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  called = false;
  asio_sockio::async_write(s, buffers, asio_sockio::transfer_at_least(10),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  called = false;
  asio_sockio::async_write(s, buffers, asio_sockio::transfer_at_least(42),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  called = false;
  asio_sockio::async_write(s, buffers, asio_sockio::transfer_exactly(1),
      bindns::bind(async_write_handler,
        _1, _2, 1, &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  called = false;
  asio_sockio::async_write(s, buffers, asio_sockio::transfer_exactly(10),
      bindns::bind(async_write_handler,
        _1, _2, 10, &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  called = false;
  asio_sockio::async_write(s, buffers, asio_sockio::transfer_exactly(42),
      bindns::bind(async_write_handler,
        _1, _2, 42, &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  called = false;
  asio_sockio::async_write(s, buffers, old_style_transfer_all,
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  called = false;
  asio_sockio::async_write(s, buffers, short_transfer,
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  int i = asio_sockio::async_write(s, buffers, short_transfer,
...
void test_4_arg_streambuf_async_write()
{
  ...
  sb.sputn(write_data, sizeof(write_data));
  bool called = false;
  asio_sockio::async_write(s, sb, asio_sockio::transfer_all(),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.sputn(write_data, sizeof(write_data));
  called = false;
  asio_sockio::async_write(s, sb, asio_sockio::transfer_at_least(1),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.sputn(write_data, sizeof(write_data));
  called = false;
  asio_sockio::async_write(s, sb, asio_sockio::transfer_at_least(10),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.sputn(write_data, sizeof(write_data));
  called = false;
  asio_sockio::async_write(s, sb, asio_sockio::transfer_at_least(42),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.sputn(write_data, sizeof(write_data));
  called = false;
  asio_sockio::async_write(s, sb, asio_sockio::transfer_exactly(1),
      bindns::bind(async_write_handler,
        _1, _2, 1, &called));
  ioc.restart();
  ioc.run();
  ...
  sb.sputn(write_data, sizeof(write_data));
  called = false;
  asio_sockio::async_write(s, sb, asio_sockio::transfer_exactly(10),
      bindns::bind(async_write_handler,
        _1, _2, 10, &called));
  ioc.restart();
  ioc.run();
  ...
  sb.sputn(write_data, sizeof(write_data));
  called = false;
  asio_sockio::async_write(s, sb, asio_sockio::transfer_exactly(42),
      bindns::bind(async_write_handler,
        _1, _2, 42, &called));
  ioc.restart();
  ioc.run();
  ...
  sb.sputn(write_data, sizeof(write_data));
  called = false;
  asio_sockio::async_write(s, sb, old_style_transfer_all,
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.sputn(write_data, sizeof(write_data));
  called = false;
  asio_sockio::async_write(s, sb, short_transfer,
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  sb.sputn(write_data, sizeof(write_data));
  int i = asio_sockio::async_write(s, sb, short_transfer,
      archetypes::lazy_handler());
  ASIO_CHECK(i == 42);
  ioc.restart();
  ioc.run();
